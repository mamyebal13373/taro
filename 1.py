...
def handle_start(message):
    ...
    bot.send_photo(message.from_user.id, open('qwe/start.jpg', 'rb'), parse_mode="Markdown",reply_markup=keyboard, caption='Перед тем, как вытащить карту, подумайте — «каким будет мой день»')
